...
import { Building2, Search, Plus, Calendar, MapPin, Users } from 'lucide-react';
  ...
  const [expos] = useState<Expo[]>([
    {
      ...
      status: 'upcoming',
      participants: 45,
      image: 'https://images.unsplash.com/photo-1587293852726-70cdb56c2866?auto=format&fit=crop&q=80&w=300&h=200'
    }
  ]);
